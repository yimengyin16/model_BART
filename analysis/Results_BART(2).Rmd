...
```{r, echo=FALSE}
make_summaryTable(df_summary_det, "bart", "Group: All BART members")
```
...
```{r, echo=FALSE}
make_summaryTable(df_summary_det, "misc", "Group: Misc members")
```

### Safety, 7% return {-}

```{r, echo = FALSE}
make_summaryTable(df_summary_det, "sfty", "Group: Safety members")
```
...
There are two BART plans, one for miscellaneous employees and one for safety (police) members. Both are participating plans of CalPERRS.   
...
### All state members {-}
```{r echo=FALSE}
make_summaryTable_detailed("bart", 0)
```

### State misc {-}
```{r echo=FALSE}
make_summaryTable_detailed("misc", 0)
```

### State safety {-}
```{r echo=FALSE}
make_summaryTable_detailed("sfty", 0)
```
...
### all state members
```{r echo=FALSE}
make_summaryTable_detailed("bart", -2)
```

### State misc
```{r echo=FALSE}
make_summaryTable_detailed("misc", -2)
```

### State safety 
```{r echo=FALSE}
make_summaryTable_detailed("sfty", -2)
```
	...
	tribble(
	  ~memberType, ~fn_ea, ~fn_age, ~fn_ageRet, ~ben_current,  ~salary_current, ~year_currentAge, ~tier,         ~row_slc,     ~indiv_label, 
	   ...
	   "servRet",      30,      60,        60,     50000,      NA,              2019,         "misc_classic",        3,           "Retiree aged 60"
		 #"servRet",      30,      65,        60,     50000,      NA,              2019,         "misc_classic"
	)
...
# df_indiv_slc <- df_indiv_slc_misc
# simName          <- "misc_benCut1_lowERC"
...
# archived code {.unlisted .unnumbered}

```{r ercPOFFpaper, eval=FALSE, include=FALSE}
...
```{r ercAllpaper, eval=FALSE, include=FALSE}
