## Loading demographic data as of 06/03/2019 for BART in AV2019 (misc and safety)


## Inputs
#   - inputs/data_raw/Data_BART_Demographics_20190603.xlsx"
...
fn_dataRaw   <- "Data_BART_Demographics_20190630.xlsx" 
...
# BART: average benefits already provided in tables
...
save(
  ...
  agecuts_retirees,
	...
	file = paste0(dir_dataOut, "Data_BART_demographics_20190630_raw.RData")
)
