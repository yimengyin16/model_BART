...
#   - filePath_planInfo <- paste0(dir_planInfo, "Data_XXX_planInfo_AVXXXX.RData")
# 
# # Output folder  
...
#                          Data preparation                                 ####
#*******************************************************************************
source("model/valuation/model_val_02_prepDataFuns.R", local = TRUE)
...
source("model/valuation/model_val_03_demographics_multiTier.R", local = TRUE)
...
#*******************************************************************************
invisible(gc())
source("model/valuation/model_val_04_indivLiab.R", local = TRUE)
...
#*******************************************************************************
invisible(gc())
source("model/valuation/model_val_05_aggLiab.R", local = TRUE)
...
val_paramlist$estInitTerm <- FALSE
...
#*******************************************************************************
# BART:
#  - Amortization payments schedule is provided in AVs. 
#  - No need to calculate using amort. basis
...
if(str_detect(val_paramlist$val_name, "misc")) init_amort_raw_val <- init_amort_misc_raw
if(str_detect(val_paramlist$val_name, "sfty")) init_amort_raw_val <- init_amort_sfty_raw 

# asset smoothing schedule
