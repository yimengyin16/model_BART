...
#'  
#'  - Benefit rules
#'      - Use benefit rules based on Misc classic members with 2.5%@57 rules.
#'        (The 2.5%@57 rule is applied to all classic members who joined before 1/15/2011, 
...
#'  Vesting: yos >=5 
#'  
#'  Cap on benefit (BART safety pepra only): 90% of final compensation
...
grp_include <- grp_include[str_detect(grp_include , "sfty_pepra")]

# weight for each group
wgts <- tibble(grp = grp_include, wgt = 0)

wgts[wgts$grp == "sfty_pepra","wgt"] <-  1
